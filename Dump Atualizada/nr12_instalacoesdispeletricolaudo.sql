...
CREATE TABLE `instalacoesdispeletricolaudo` (
  ...
  CONSTRAINT `fk_instalacoesdispeletricolaudo_instalacoesdispeletrico1` FOREIGN KEY (`instalacoesdispeletricoId`) REFERENCES `instalacoesdispeletrico` (`id`),
  CONSTRAINT `fk_instalacoesdispeletricolaudo_laudo1` FOREIGN KEY (`laudoId`) REFERENCES `laudo` (`id`)
